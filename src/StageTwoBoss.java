...
public class StageTwoBoss extends SpaceShips{
	...
	public void fire() {
		...
		bulletsFired.add(new Projectiles(getX()+200, getY()+500, 5,xVelo, bullets[1],1)); // + 50 for center 100+ for height
		bulletsFired.add(new Projectiles(getX()+600, getY()+500, 5,xVelo, bullets[1],1)); // + 50 for center 100+ for height
	}
}
